    ...
    <div style={{ position: "relative" }}>
      ...
      >
        ...
        <span style={{
          ...
          padding: "2px 5px", borderRadius: 4, border: "1px solid rgba(245,158,11,0.2)",
            ...
            <div style={{ padding: "14px 16px", borderBottom: "1px solid var(--border)", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div>
                <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 2 }}>
                  <span style={{ fontSize: 10, fontFamily: "var(--font-mono)", color: "#f59e0b", fontWeight: 700 }}>PAPER TRADING</span>
                </div>
                <div style={{ fontSize: 11, color: "var(--text-3)" }}>No real money · Reset anytime</div>
              </div>
